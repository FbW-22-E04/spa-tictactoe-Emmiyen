...
return {
...prevState, board: action.move.board, player: action.move.prevPlayer == 'X' ? 'O' : 'X'
}
case 'clicked':
...
checkWin:
function(aBoard){
if((aBoard.filter(letter=>letter !== null)).length<3)
return false;
if(
(aBoard[0]!==null && aBoard[0]===aBoard[1] && aBoard[0]===aBoard[1] && aBoard[1] === aBoard[2]) ||
